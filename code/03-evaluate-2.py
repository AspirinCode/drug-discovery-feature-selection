'''
Train 3 classifiers using pubchem hiv+decoy dataset and test it against herbal Indonesia dataset:
...
if len(results) > 0:
    ...
    plt.ylabel('Scores')
    plt.title('Classification Metrics Comparison on Herbal Indonesia Dataset')
